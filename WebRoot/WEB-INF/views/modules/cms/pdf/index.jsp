...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    <meta charset="utf-8">
    <meta http-equiv="Access-Control-Allow-Origin" content="http://*.aliyuncs.com">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<!--#if GENERIC || CHROME-->
    <meta name="google" content="notranslate">
    
<!--#endif-->
    <title>${articleAttFile.attfilekey}</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/pdf/web/viewer.css"/>
<!--#if !PRODUCTION-->
    <link rel="resource" type="application/l10n" href="<%=request.getContextPath()%>/resources/pdf/web/locale/locale.properties"/>
<!--#endif-->
	
<!--#if !(MOZCENTRAL || CHROME || MINIFIED)-->
    <script src="<%=request.getContextPath()%>/resources/pdf/web/compatibility.js"></script>
<!--#endif-->

<!--#if !PRODUCTION-->
    <script src="<%=request.getContextPath()%>/resources/pdf/external/webL10n/l10n.js"></script>
<!--#endif-->

 <script src="<%=request.getContextPath()%>/resources/pdf/build/pdf.js"></script>
<!--#if !PRODUCTION-->
    <script src="<%=request.getContextPath()%>/resources/pdf/web/ui_utils.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/default_preferences.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/preferences.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/download_manager.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/view_history.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/pdf_rendering_queue.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/page_view.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/text_layer_builder.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/pdf_viewer.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/thumbnail_view.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/document_outline_view.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/document_attachments_view.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/pdf_find_bar.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/pdf_find_controller.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/pdf_history.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/secondary_toolbar.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/presentation_mode.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/grab_to_pan.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/hand_tool.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/overlay_manager.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/password_prompt.js"></script>
    <script src="<%=request.getContextPath()%>/resources/pdf/web/document_properties.js"></script>
<!--#endif-->

<!--#if !MINIFIED -->
    <script src="<%=request.getContextPath()%>/resources/pdf/web/debugger.js"></script>
    <script >
...
'use strict';
//
var DEFAULT_URL = '${ctx}/f/viewff?id=${articleAttFile.id}';
...
//#endif
//#if !PRODUCTION
PDFJS.cMapUrl = '<%=request.getContextPath()%>/resources/pdf/external/bcmaps/';
