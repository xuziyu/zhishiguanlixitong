...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true,chkboxType: { "Y": "s", "N": "s" }},
				...
				data:{simpleData:{enable:true}},callback:{<%--
					...
					onClick:function(event, treeId, treeNode){
						$('#isparent').attr('value',treeNode.isParent);
						...
						for (var i=0, l=nodes.length; i<l; i++){
							...
							list=list+","+nodes[i].id;
							pidlist=pidlist+","+nodes[i].pid;
						}
						$('#taglist').attr('value',list);
						return false;
...
<body>
	...
	<input id="isparent" name="taglist" type="hidden" value=""/>
</body>